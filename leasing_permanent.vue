        ...
        return Vue.component("leasing-permanent-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', { url: this.property.mm_host + "/pages/simcoe-permanent-leasing.json"})]);
                        return results;
                    } catch (e) {
                ...
                validateBeforeSubmitPerm() {
                    this.$validator.validate().then((result) => {
                        ...
                        if (result) {
                            ...
                            perm_formdata.subject = "Simcoe Town Centre Permanent Leasing Form"; 
                            perm_formdata.body = {};
