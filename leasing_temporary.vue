        ...
        return Vue.component("leasing-temporary-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', { url: this.property.mm_host + "/pages/simcoe-temporary-leasing.json"})]);
                        return results;
                    } catch (e) {
                ...
                validateBeforeSubmitTemp() {
                    ...
                    this.$validator.validate().then((result) => {
                        if (result) {
                            ...
                            temp_formdata.subject = "Simcoe Town Centre Specialty Leasing Form"; 
                            temp_formdata.body = {};
